...
function(check_package name)
  ...
  if(DEFINED ${upperName}_INCLUDE_DIR)
    ...
    set(${upperName}_INCLUDE_DIR ${${upperName}_INCLUDE_DIR} PARENT_SCOPE)
  endif()
  if(${${name}_FOUND})
    set(libStatus "Ready")
  ...
  elseif(${${upperName}_FOUND})
    set(libStatus "Ready")
    set(libColor BoldCyan)
    set(${upperName}_FOUND ${${upperName}_FOUND} PARENT_SCOPE)
  else()
...
function(check_library name)
  ...
  if(LIBRARY_NOTFOUND)
    ...
    if(_isRequired)
      message(FATAL_ERROR "Some parts of the library \"${name}\" could not be found. Because it is required, cmake project configuration cannot continue.")
