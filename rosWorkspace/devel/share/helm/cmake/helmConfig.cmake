...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'helm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brian/mk-proto/rosWorkspace/src/helm/${idir}'.  Ask the maintainer 'brian <brian@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/brian/mk-proto/rosWorkspace/devel/lib;/home/brian/mk-proto/rosWorkspace/devel/lib;/opt/ros/hydro/lib)
