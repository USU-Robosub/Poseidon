...
# "> readm 0x48304000 10"
function readm {
  /home/debian/Desktop/Poseidon/kernel/memory/main -r $1 $2 0 1
}

# use to write register address (once)
# "> writem 0x48304000 214 61A8"
function writem {
  /home/debian/Desktop/Poseidon/kernel/memory/main -w $1 $2 $3 1
}

function load_i2c {
	echo BB-I2C1 > $SLOTS
	source /home/debian/Desktop/Poseidon/kernel/memory/script.sh
	i2c2_enable
}
